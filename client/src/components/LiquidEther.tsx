...
export default function LiquidEther({
    ...
    resolution = 0.5,
    isBounce = false,
    colors = ['#f0f0f0', '#e0e0e0', '#cccccc'], // Default to light gray
    style = {},
    className = '',
    autoDemo = true,
    autoSpeed = 0.5,
    ...
    const webglRef = useRef<any>(null); // Using any for the complex WebGL manager class to avoid full typing
...
`;
        ...
        class Simulation {
            ...
            update() {
                ...
                if (this.advection && this.externalForce && this.viscous && this.divergence && this.poisson && this.pressure) {
